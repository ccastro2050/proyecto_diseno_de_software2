...
> el puerto 8053 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                         STATUS                    PORTS
> proyecto_diseno_de_software2-api-facturas-1   Up 2 hours                0.0.0.0:8053->8053/tcp
> proyecto_diseno_de_software2-postgres-1       Up 2 hours (healthy)      0.0.0.0:15453->5432/tcp
> ```
>
...
```powershell
git clone https://github.com/ccastro2050/proyecto_diseno_de_software2.git
cd proyecto_diseno_de_software2
...
| Qué | Dónde |
|---|---|
| **API Facturas** — diagnóstico | http://localhost:8053/ |
| **Swagger** (documentación interactiva: ver y probar los endpoints) | http://localhost:8053/swagger |
| Listar productos | http://localhost:8053/api/producto |
| PostgreSQL (para SQLTools/pgAdmin, opcional) | `localhost:15453` · `postgres`/`Diseno123!` |
...
> ℹ️ Este proyecto usa los puertos 8053 y 15453: si alguno ya está ocupado
...
│
├── api_facturas/                # LA API DE LA v1 — C#/ASP.NET Core (puerto 8053)
