...
> [README](../README.md)). PostgreSQL queda publicado en `localhost:15453`.
...
| Port | `15453` | El puerto del host del compose (`15453:1433`) |
...
> El puerto es la clave: **15453, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 15453
...
>
> ```
> Error opening connection Failed to connect to localhost:15453
...
> (`http://localhost:8053/api/producto/PR009`) — un solo dato, muchos
> clientes.
...
| 1 | Crear la conexión (localhost:15453) con test y guardarla |
